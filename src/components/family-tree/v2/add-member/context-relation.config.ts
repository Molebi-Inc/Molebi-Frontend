...
> = {
  ...
  stepfather: {
    ...
    brother: ok('uncle', 'target', 'Your Uncle'),
    sister: ok('aunt', 'target', 'Your Aunt'),
    partner: ok('stepmother', 'target', "Your Step-Parent's Spouse"),
    son: ok('sibling', 'target', 'Your Sibling'),
    daughter: ok('sibling', 'target', 'Your Sibling'),
  ...
  stepmother: {
    ...
    brother: ok('uncle', 'target', 'Your Uncle'),
    sister: ok('aunt', 'target', 'Your Aunt'),
    partner: ok('stepfather', 'target', "Your Step-Parent's Spouse"),
    son: ok('sibling', 'target', 'Your Sibling'),
    daughter: ok('sibling', 'target', 'Your Sibling'),
    'step-brother': ok('step_sibling', 'target_parent', 'Your Step-Sibling', {
      prerequisite: 'paternal_grandfather',
  ...
  sibling: {
    ...
    partner: ok('spouse', 'target', 'Your Sibling-In-Law'),
  ...
  child: {
    ...
    partner: ok('spouse', 'target', 'Your Child-In-Law'),
  ...
  stepchild: {
    ...
    partner: ok('spouse', 'target', "Your Step-Child's Spouse (In-Law)"),
    son: ok('grandchild', 'target', 'Your Grandchild'),
    daughter: ok('grandchild', 'target', 'Your Grandchild'),
  ...
  paternal_grandfather: {
    ...
    partner: ok('paternal_grandmother', 'target', "Your Paternal Grandparent's Spouse"),
  ...
  paternal_grandmother: {
    ...
    brother: off('No relationship type for great-uncle — add relatives via the grandparent node'),
    sister: off('No relationship type for great-aunt — add relatives via the grandparent node'),
    partner: ok('paternal_grandfather', 'target', "Your Paternal Grandparent's Spouse"),
    son: ok('uncle', 'target', 'Your Uncle'),
    daughter: ok('aunt', 'target', 'Your Aunt'),
  ...
  maternal_grandfather: {
    ...
    brother: off('No relationship type for great-uncle — add relatives via the grandparent node'),
    sister: off('No relationship type for great-aunt — add relatives via the grandparent node'),
    partner: ok('maternal_grandmother', 'target', "Your Maternal Grandparent's Spouse"),
    son: ok('uncle', 'target', 'Your Uncle'),
    daughter: ok('aunt', 'target', 'Your Aunt'),
  ...
  maternal_grandmother: {
    ...
    brother: off('No relationship type for great-uncle — add relatives via the grandparent node'),
    sister: off('No relationship type for great-aunt — add relatives via the grandparent node'),
    partner: ok('maternal_grandfather', 'target', "Your Maternal Grandparent's Spouse"),
    son: ok('uncle', 'target', 'Your Uncle'),
    daughter: ok('aunt', 'target', 'Your Aunt'),
  ...
  grandchild: {
    ...
    partner: ok('spouse', 'target', "Your Grandchild's Spouse (In-Law)"),
  ...
  great_grandfather: {
    ...
    partner: ok('spouse', 'target', "Your Great-Grandparent's Spouse (In-Law)"),
  ...
  great_grandchild: {
    ...
    partner: ok('spouse', 'target', "Your Great-Grandchild's Spouse (In-Law)"),
  ...
  aunt: {
    father: ok('grandfather', 'target', 'Your Grandfather'),
    mother: ok('grandmother', 'target', 'Your Grandmother'),
    brother: ok('uncle', 'target_related_through', 'Your Uncle'),
    sister: ok('aunt', 'target_related_through', 'Your Aunt'),
    partner: ok('spouse', 'target', 'Your In-law'),
  ...
  cousin: {
    ...
    partner: ok('spouse', 'target', "Your Cousin's Spouse (In-Law)"),
  ...
  father_in_law: {
    ...
    partner: ok('spouse', 'target', "Your In-Law's Spouse"),
    ...
    if (entry.prerequisite) {
      ...
      if (!met) {
        result[key] = {
          ...
          disabled: true,
          disabledReason:
            entry.disabledReason ?? `Add ${entry.prerequisite.replace(/_/g, ' ')} first`,
        }
        continue
      }
    }
