<template>
  <MlbModal
    ...
    :bottom-sheet-height="320"
    @update:show="$emit('update:show', $event)"
  >
    <div class="flex flex-col gap-1 py-1">
      <!-- Cancel link -->
      <button
        class="self-start text-sm text-neutral-500 hover:text-neutral-800 transition-colors mb-2"
      ...
      <div class="border-2 border-dashed border-neutral-200 rounded-2xl p-6 flex flex-col items-center text-center gap-3">
        <!-- Trash icon circle -->
        <div class="w-14 h-14 rounded-full bg-red-50 flex items-center justify-center">
          <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              d="M4 7H22M8 7V4H18V7M10 12V19M16 12V19M5 7L6 22H20L21 7H5Z"
              stroke="#EF4444"
              stroke-width="1.8"
